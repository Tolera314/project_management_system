...
export default function MilestoneDetailPanel({ milestone, onClose, onRefresh }: MilestoneDetailPanelProps) {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="p-6 border-b border-white/5 flex items-center justify-between bg-surface/80 backdrop-blur-xl sticky top-0 z-10">
            ...
            {/* Actions */}
            <div className="p-6 border-t border-white/5 bg-surface/50 backdrop-blur-xl">
