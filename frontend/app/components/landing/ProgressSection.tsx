...
export default function ProgressSection() {
    return (
        <section className="py-24 px-6 bg-background relative border-t border-white/5">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-4 pt-4">
                            <div className="flex-1 p-4 bg-surface rounded-xl border border-white/5">
                    ...
                    <div className="relative h-[400px] w-full bg-surface border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col justify-end">
                            ...
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div key={i} className="flex items-center gap-4">
                                    ...
                                    <motion.div
                                        ...
                                        className={`h-6 rounded bg-white/10 ${i === 2 ? 'bg-primary/50' : ''}`}
                                    />
                                </div>
                            ))}
                        </div>

                        <div className="border-t border-white/10 pt-4 flex justify-between text-xs text-text-secondary font-mono">
                            <span>DEC 01</span>
                            <span>DEC 15</span>
                            <span>JAN 01</span>
                        </div>
