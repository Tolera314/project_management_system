            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                        ...
                        <button className="w-full sm:w-auto px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl font-semibold transition-all backdrop-blur-sm">
                            View Demo
                        </button>
                    </div>
                </motion.div>
