...
export default function ProjectContextMenu({ isOpen, onClose, projectName, onAction }: ProjectContextMenuProps) {
    ...
    return (
        <motion.div
            ...
            className="absolute left-full top-1/2 -translate-y-1/2 ml-3 w-64 bg-surface/95 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl z-[60] overflow-hidden py-1.5"
        >
