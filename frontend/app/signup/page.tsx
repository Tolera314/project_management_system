        ...
        <div className="min-h-screen bg-background flex flex-col justify-between relative overflow-hidden font-sans">
            ...
            <main className="relative z-10 w-full max-w-md mx-auto px-6 flex-1 flex flex-col justify-center py-16 lg:py-20">
                ...
                <motion.div
                    ...
                    className="relative bg-gradient-to-b from-surface/60 to-surface/40 border border-white/[0.08] rounded-3xl p-8 backdrop-blur-2xl shadow-2xl shadow-black/40"
                >
                    {/* Subtle inner glow */}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative z-10">
                        ...
                        {error && (
                            <motion.div
                                initial={{ opacity: 0, y: -10 }}
                                animate={{ opacity: 1, y: 0 }}
                                className="p-3.5 bg-danger/10 border border-danger/20 rounded-xl text-danger text-sm text-center backdrop-blur-sm"
                            >
                                {error}
                            </motion.div>
                        )}
