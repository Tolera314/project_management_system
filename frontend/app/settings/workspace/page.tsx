            ...
            <div className="p-6 md:p-10 max-w-5xl mx-auto">
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl md:text-3xl font-bold text-white">Workspace Settings</h1>
                    </div>
                    <p className="text-slate-400">Manage your workspace identity, members, and billing.</p>
                </motion.div>
