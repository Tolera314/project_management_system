...
import WorkspaceRolesList from '../../../components/dashboard/WorkspaceRolesList';
            ...
            <div className="p-6 md:p-10 max-w-5xl mx-auto">
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl md:text-3xl font-bold text-white">Roles & Permissions</h1>
                    </div>
                    <p className="text-slate-400">View and understand the roles available in your workspace.</p>
                </motion.div>
